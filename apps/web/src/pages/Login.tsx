            ...
            <div className="space-y-4">
              ...
              <button
                onClick={() => {
                  ...
                  setIsKakaoLogin(false);
                  // Google 로그인 트리거
                  const googleButton = document.querySelector('iframe[src*="accounts.google.com"]')?.parentElement?.querySelector('div[role="button"]') as HTMLElement;
                  if (googleButton) {
                    googleButton.click();
                  }
                }}
                disabled={loading}
                className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg border border-gray-300 flex items-center justify-center transition-colors disabled:opacity-50"
              >
